...
// 默认配置
const defaultConfig: HttpGlobalConfig = {
    timeout: 30000,
    headers: {
...
// 全局配置实例
let globalConfig: HttpGlobalConfig = { ...defaultConfig };
 ...
 * 获取全局配置
 */
export function getHttpConfig(): HttpGlobalConfig {
    return globalConfig;
}
 ...
 */
export function getErrorMessage(code: string | number, defaultMessage: string): string {
 ...
 * 处理认证失败
 */
export function handleAuthFailed(): void {
