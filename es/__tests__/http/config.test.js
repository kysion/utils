import { configureHttp, resetHttpConfig, getHttpConfig, getErrorMessage, getCurrentLanguage, getAuthToken, handleAuthFailed, defaultConfig, DEFAULT_ERROR_MESSAGES } from '../../http/config';
// 全局变量模拟
...
describe('HTTP配置模块', () => {
    ...
    describe('getErrorMessage', () => {
        ...
        test('应使用提供的翻译函数', () => {
            const translateFn = jest.fn().mockImplementation((code, defaultMsg) => `错误 ${code}: ${defaultMsg}`);
            configureHttp({
